...
@NamedQueries({
    ...
    , @NamedQuery(name = "Transaccion.findByTipo1", query = "SELECT t FROM Transaccion t WHERE t.tipo1 = :tipo1")})
public class Transaccion implements Serializable {
    ...
    public Transaccion(TransaccionPK transaccionPK, Date fecha, long cantidad, Character tipo, Date fechaAprobacion, Character tipo1) {
        this.transaccionPK = transaccionPK;
        this.fecha = fecha;
    ...
    public Character getTipo1() {
        return tipo1;
    }

    public void setTipo1(Character tipo1) {
        this.tipo1 = tipo1;
    }
