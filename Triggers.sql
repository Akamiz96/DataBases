...
create or replace TRIGGER Trigger_AuditoriaAprobada
  ...
  BEGIN
    CASE
      ...
      WHEN (DELETING) THEN
        INSERT INTO AUDITORIAAPROBADA VALUES(SYSDATE,'I',NULL, NULL, NULL, :OLD.TRANSACCION_ID,:OLD.TRANSACCION_DEUDA_CUENTA_ID, :OLD.TRANSACCION_DEUDA_USUARIO_ID, :OLD.TRANSACCION_DEUDA_ID_DEUDA, :OLD.LIDERGRUPO_FECHAINGRESO, :OLD.LIDERGRUPO_GRUPO_ID, :OLD.LIDERGRUPO_USUARIO_ID);
      WHEN (UPDATING ('FECHA_APROBACION')) THEN
        INSERT INTO AUDITORIAAPROBADA VALUES(SYSDATE,'I',:NEW.FECHA_APROBACION, :OLD.FECHA_APROBACION, 'FECHA_APROBACION', :NEW.TRANSACCION_ID,:NEW.TRANSACCION_DEUDA_CUENTA_ID, :NEW.TRANSACCION_DEUDA_USUARIO_ID, :NEW.TRANSACCION_DEUDA_ID_DEUDA, :NEW.LIDERGRUPO_FECHAINGRESO, :NEW.LIDERGRUPO_GRUPO_ID, :NEW.LIDERGRUPO_USUARIO_ID);
    END CASE;
  END;
  ...
  BEGIN
    CASE
      ...
      WHEN (UPDATING ('FECHASALIDA')) THEN
        INSERT INTO AUDITORIALIDERGRUPO VALUES(SYSDATE,'I',:NEW.FECHASALIDA, :OLD.FECHASALIDA, 'FECHASALIDA', :NEW.FECHAINGRESO,:NEW.GRUPO_ID, :NEW.USUARIO_ID);
    END CASE;
  END;